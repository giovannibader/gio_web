...
So I started to entering the data manually in excel and then transfer them in Systat. Point and click. Easy.
...
With more data available (Big Data) the emphasis was more on data visualization (sometime in real time) and reports easy to understand. The interest is more on the trend and the behaviours of variables. I like to think of an evolution of what it was called descriptive statistics (in the end it's just tables and plots). So, Data Mining approach can be seen as a way to explore Big Data.
